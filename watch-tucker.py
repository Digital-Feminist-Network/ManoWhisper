...
logging.basicConfig(
    filename="watch-tucker.log", level=logging.INFO, format="%(asctime)s - %(message)s"
)

# Constants.
output_dir = "/mnt/vol1/data_sets/digfem/podcast-analysis/media/The Tucker Carlson Show/vtt"
watch_dir = "/mnt/vol1/data_sets/digfem/podcast-analysis/media/The Tucker Carlson Show/mp3"

queue_file = "tucker-queue.txt"
