...
logging.basicConfig(
    filename="watch-candace.log", level=logging.INFO, format="%(asctime)s - %(message)s"
)

# Constants.
output_dir = "/mnt/vol1/data_sets/digfem/podcast-analysis/media/Candace Owens/vtt"
watch_dir = "/mnt/vol1/data_sets/digfem/podcast-analysis/media/Candace Owens/mp3"

queue_file = "candace-queue.txt"
