...
logging.basicConfig(
    filename="watch-tpool.log", level=logging.INFO, format="%(asctime)s - %(message)s"
)

# Constants.
output_dir = "/mnt/vol1/data_sets/digfem/podcast-analysis/media/The Culture Ware Podcast with Tim Pool/vtt"
watch_dir = "/mnt/vol1/data_sets/digfem/podcast-analysis/media/The Culture Ware Podcast with Tim Pool/mp3"

queue_file = "tpool-queue.txt"
